...
*/
        ...
        Intent alarmIntent = new Intent(Main2Activity.this, AlarmManagerBroadcastReceiver.class);
...
*/
        ...
        operatorType = getOperatorType();
         try {
            signalStrenght = ConnectionDetector.getSignalStrenght(Main2Activity.this);
        } catch (Exception e) {
            e.printStackTrace();
            //  fillDataInDatabase("");
        ...
        try {
            networkSubType = ConnectionDetector.getNetworkSubType(Main2Activity.this);
        } catch (Exception e) {
            e.printStackTrace();
            // fillDataInDatabase("");
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, urlData, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    //sendError(e.toString(), "user/login?username=");
                    Toast.makeText(Main2Activity.this, "Technical Error...", Toast.LENGTH_SHORT).show();
                    pDialog.dismiss();
                }
            }
